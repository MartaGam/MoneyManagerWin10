...
namespace MoneySplitter.Services.Api
{
	public class ApiUrlBuilder : IApiUrlBuilder
	{
		...
		public Uri ChangeBalance(double newValue)
		{
			return new Uri(string.Concat(
				Defines.Api.WEB_API_URL,
				"/transactions",
				"/changebalance",
				CreateQueryParameter("newValue", newValue)));
		}
		...
		public Uri ApproveAllTransactionsForFriend(int friendId)
		{
			return new Uri(string.Concat(
				Defines.Api.WEB_API_URL,
				Defines.Api.Transactions.TRANSACTIONS,
				"/approveall", CreateQueryParameter("friendId", friendId)));
		}
